### **mht2png & mpkg2zip**
将.mht网页存档文件中的图片文件提取出来、将.mpkg文件总体转换为.zip文件的Python脚本 
适配Android端QPython v3兼容性，Python3.x亦可使用。
在QPython中选择文件导入运行，在安装Python的电脑中双击运行即可。😁

关于mpkg2zip.py的故事 https://www.52pojie.cn/thread-2106085-1-1.html
